...
{
	/// <summary>
	/// A base class for a functional unit of the UI.
	///
	/// <para>
	/// This class is borrowed form the Unity UI Toolkit Dragon Crashers Sample.
	/// </para>
	/// </summary>
	public class UIView : IDisposable
	{
		...
		// UI reveals other underlying UIs, partially see-through
		...
		// Unregister any callbacks or event handlers. Override to customize.
